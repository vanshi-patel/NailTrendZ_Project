<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="moreproducts.ascx.cs" Inherits="ProjectSem6.moreproducts1" %>

<div class="product_section layout_padding">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="product_taital">Nail Palette - More Products</h1>
            </div>
        </div>
